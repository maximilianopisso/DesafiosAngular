...
export const environment = {
  ...
  urlMovieAPI: 'https://61d4aafe8df81200178a8def.mockapi.io/movies',
  //urlImage: 'https://image.tmdb.org/t/p/w500/',
  urlUsersAPI: 'https://61bcb895d8542f00178249b1.mockapi.io/api/persons',

  //Descomposicion de key y direccion para realizar busquedas por id de peliculas
  keyAPI:'?api_key=31071a84eb5283914ae9190214c1a7f4',
